...
* **Data Structures:** Arrays, Strings, Linked Lists, Stacks, Queues, Hash Tables, Trees, Heaps, Graphs
* **Algorithms:** Two Pointers, Sliding Window, Binary Search, Recursion, Backtracking, Dynamic Programming, Greedy, Bit Manipulation
* **Focus:** Low-level memory management (`malloc`/`free`), pointer manipulation, and optimal Time & Space complexity ($O(1)$ auxiliary space optimizations).
